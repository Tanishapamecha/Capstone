...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 04, 2024 at 09:30 PM
...
(1, 'tanisha@gmail.com', 'tanisha1234');
...
(81, 'Can add order master', 21, 'add_ordermaster'),
(82, 'Can change order master', 21, 'change_ordermaster'),
(83, 'Can delete order master', 21, 'delete_ordermaster'),
(84, 'Can view order master', 21, 'view_ordermaster'),
...
(93, 'Can add wholesaler', 24, 'add_wholesaler'),
(94, 'Can change wholesaler', 24, 'change_wholesaler'),
(95, 'Can delete wholesaler', 24, 'delete_wholesaler'),
(96, 'Can view wholesaler', 24, 'view_wholesaler');
...
CREATE TABLE `category` (
  ...
  `c_subcategory` varchar(30) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `customer` (
  ...
  `cust_gender` tinyint(1) DEFAULT NULL,
  `cust_email` varchar(30) DEFAULT NULL,
  `cust_password` varchar(20) DEFAULT NULL,
  `cust_mobileno` varchar(10) DEFAULT NULL,
  `cust_addressline1` varchar(20) DEFAULT NULL,
  `cust_addressline2` varchar(100) DEFAULT NULL,
  `cust_addressline3` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(2, 'auth', 'permission'),
(4, 'auth', 'user'),
(7, 'Bizease_app', 'authgroup'),
(8, 'Bizease_app', 'authgrouppermissions'),
(9, 'Bizease_app', 'authpermission'),
(10, 'Bizease_app', 'authuser'),
(11, 'Bizease_app', 'authusergroups'),
(12, 'Bizease_app', 'authuseruserpermissions'),
(13, 'Bizease_app', 'cart'),
(14, 'Bizease_app', 'category'),
(15, 'Bizease_app', 'customer'),
(16, 'Bizease_app', 'djangoadminlog'),
(17, 'Bizease_app', 'djangocontenttype'),
(18, 'Bizease_app', 'djangomigrations'),
(19, 'Bizease_app', 'djangosession'),
(20, 'Bizease_app', 'feedback'),
(21, 'Bizease_app', 'ordermaster'),
(22, 'Bizease_app', 'payment'),
(23, 'Bizease_app', 'product'),
(24, 'Bizease_app', 'wholesaler'),
...
(1, 'contenttypes', '0001_initial', '2024-03-03 09:30:41.673115'),
(2, 'auth', '0001_initial', '2024-03-03 09:30:42.264732'),
(3, 'admin', '0001_initial', '2024-03-03 09:30:42.397251'),
(4, 'admin', '0002_logentry_remove_auto_add', '2024-03-03 09:30:42.403295'),
(5, 'admin', '0003_logentry_add_action_flag_choices', '2024-03-03 09:30:42.409017'),
(6, 'contenttypes', '0002_remove_content_type_name', '2024-03-03 09:30:42.482033'),
(7, 'auth', '0002_alter_permission_name_max_length', '2024-03-03 09:30:42.541108'),
(8, 'auth', '0003_alter_user_email_max_length', '2024-03-03 09:30:42.560925'),
(9, 'auth', '0004_alter_user_username_opts', '2024-03-03 09:30:42.567235'),
(10, 'auth', '0005_alter_user_last_login_null', '2024-03-03 09:30:42.614399'),
(11, 'auth', '0006_require_contenttypes_0002', '2024-03-03 09:30:42.617562'),
(12, 'auth', '0007_alter_validators_add_error_messages', '2024-03-03 09:30:42.623226'),
(13, 'auth', '0008_alter_user_username_max_length', '2024-03-03 09:30:42.634894'),
(14, 'auth', '0009_alter_user_last_name_max_length', '2024-03-03 09:30:42.647258'),
(15, 'auth', '0010_alter_group_name_max_length', '2024-03-03 09:30:42.660424'),
(16, 'auth', '0011_update_proxy_permissions', '2024-03-03 09:30:42.666428'),
(17, 'auth', '0012_alter_user_first_name_max_length', '2024-03-03 09:30:42.680483'),
(18, 'sessions', '0001_initial', '2024-03-03 09:30:42.726195'),
(19, 'Bizease_app', '0001_initial', '2024-03-04 20:17:51.584304');
...
('8rc1obm2x5jyr04bo49609oq57s47xka', 'eyJhX2VtYWlsIjoidGFuaXNoYUBnbWFpbC5jb20ifQ:1rhEwl:IdDp23rLNLrGTyyvEfPzHkOhwTv3wFAu_zTlDcMIKBY', '2024-03-18 20:30:03.901878');
...
CREATE TABLE `feedback` (
  ...
  `f_details` varchar(100) DEFAULT NULL,
  `cust_id` int(5) DEFAULT NULL,
  `p_id` int(10) DEFAULT NULL,
...
--
-- Table structure for table `order-master`
--

CREATE TABLE `order-master` (
  `o_id` int(10) NOT NULL,
  `o_date` date DEFAULT NULL,
  `cust_id` int(5) DEFAULT NULL,
  `o_status` varchar(49) DEFAULT NULL,
  `p_id` int(10) DEFAULT NULL,
  `o_quantity` int(3) DEFAULT NULL,
  `o_price` decimal(10,0) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `payment` (
  ...
  `p_paymentmode` varchar(20) DEFAULT NULL,
  `w_id` int(5) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `wholesaler` (
  ...
  `w_password` varchar(40) DEFAULT NULL,
  `w_mobile_no` int(10) DEFAULT NULL,
  `w_address` varchar(300) DEFAULT NULL,
  `w_image` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
ALTER TABLE `feedback`
  ...
  ADD KEY `products` (`p_id`),
  ADD KEY `orders_master` (`o_id`),
  ADD KEY `customer` (`cust_id`);

--
-- Indexes for table `order-master`
--
ALTER TABLE `order-master`
...
ALTER TABLE `payment`
  ...
  ADD KEY `customers` (`cust_id`),
  ADD KEY `wholesaler` (`w_id`);
...
ALTER TABLE `product`
  ADD PRIMARY KEY (`p_id`),
  ADD KEY `customer_category` (`c_id`),
  ADD KEY `category_product` (`w_id`);
...
--
-- AUTO_INCREMENT for table `order-master`
--
ALTER TABLE `order-master`
...
ALTER TABLE `feedback`
  ...
  ADD CONSTRAINT `orders_master` FOREIGN KEY (`o_id`) REFERENCES `order-master` (`o_id`),
  ADD CONSTRAINT `products` FOREIGN KEY (`p_id`) REFERENCES `product` (`p_id`);

--
-- Constraints for table `order-master`
--
ALTER TABLE `order-master`
  ADD CONSTRAINT `customer_id` FOREIGN KEY (`cust_id`) REFERENCES `order-master` (`o_id`),
  ADD CONSTRAINT `product_id` FOREIGN KEY (`p_id`) REFERENCES `order-master` (`o_id`);

--
-- Constraints for table `payment`
--
ALTER TABLE `payment`
  ADD CONSTRAINT `customers` FOREIGN KEY (`cust_id`) REFERENCES `customer` (`cust_id`),
  ADD CONSTRAINT `wholesaler` FOREIGN KEY (`w_id`) REFERENCES `wholesaler` (`w_id`);

--
-- Constraints for table `product`
--
ALTER TABLE `product`
  ADD CONSTRAINT `category_product` FOREIGN KEY (`w_id`) REFERENCES `wholesaler` (`w_id`),
  ADD CONSTRAINT `customer_category` FOREIGN KEY (`c_id`) REFERENCES `category` (`c_id`);
COMMIT;
